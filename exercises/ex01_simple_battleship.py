...
#p2 picking boat location
p2_input = int(input("Pick a secret boat location between 1 and 4: "))
if int(p2_input) > 4:
    print(f"Error! {p2_input} too high! ")
    exit()
if int(p2_input) < 1:
    print(f"Error! {p2_input} too low! ")
    exit()

#p1 guessing boat location
p1_guess = int(input("Guess a number between 1 and 4: "))
if int(p1_guess) > 4:
